...
|                                                                       |
INST1
echo -e "|"  "\e[32mTo run the startup script, just type the sudoer password\e[0m              |"
echo -e "|"  "\e[32mThe sudoer password is 'owncloud', or the PW you chose during install\e[0m |"
cat << INST2
|                                                                       |
| If you never done this before you can follow the complete             |
| install instructions: https://goo.gl/3FYtz6                           |
|                                                                       |
| You can also set the ownCloud update process as a cron job.           |
